...
const Headers = () => {
    ...
    return (
        <div className='w-full bg-white'>
            <div className='header-top bg-[#00535B] md-lg:hidden'>
                <div className='w-[85%] lg:w-[90%] mx-auto'>
                    <div className='flex w-full justify-between items-center h-[50px] text-slate-500'>
                      
                        <h1 className='text-white h1 font-bold text-md cursor-pointer'>MAQBOOL</h1>
                    ...
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            ...
                            <div className='flex justify-end flex-col gap-1'>
                                <h2 className='text-sm font-medium text-slate-700'>+234803243243</h2>
            ...
            <div className='w-[90%] lg:w-[90%] mx-auto'>
                <div className='flex w-full flex-wrap md-lg:gap-8'>
                    <div className='w-1/12 md-lg:w-full'>
                        <div className='bg-white relative'>
                            <div onClick={() => setCategoryShow(!categoryShow)} className='h-[50px] bg-teal-400 text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-bold text-md cursor-pointer'>
                    ...
                    <div className='w-9/12 pl-8 md-lg:pl-0 md-lg:w-full'>
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                                    ...
                                    <li>
                                        <Link className={`p-2 block ${pathname === '/' ? 'text-[#7fad39]' : 'text-slate-600'}`}><GrHomeRounded size={28}/></Link>
                                    </li>
                                    <li>
                                        <Link to='/shops' className={`p-2 block ${pathname === '/shop' ? 'text-[#7fad39]' : 'text-slate-600'}`}><FiShoppingCart size={28}/></Link>
                                    </li>
                                    
                                    <li>
                                        <Link className={`p-2 block ${pathname === '/about' ? 'text-[#7fad39]' : 'text-slate-600'}`}><FaRegUser size={28}/></Link>
                                    </li>
                                    ...
                                    <input className='w-full relative bg-transparent text-slate-500 outline-0 px-3 h-full right-0' onChange={(e) => setSearchValue(e.target.value)} type="text" name="" id="" placeholder='Search Here...' />
                                    <button onClick={search} className='bg-teal-400 right-0 absolute px-8 h-full font-semibold uppercase text-white'><FaSearch /></button>
                                </div>
                            </div>
                            <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0'>
                                <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                    ...
                                    {/* </div> */}
                                    <div className='flex justify-end flex-col gap-1'>
                                        {/* <h2 className='text-md font-medium text-slate-700'>+2348035542602</h2> */}
