        ...
        <div>
            ...
            <div className='bg-slate-200 mt-4'>
                <div className='w-full justify-center items-center p-10'>
                    <div className='w-[65%] mx-auto bg-white rounded-md'>
                        <div className='px-8 py-8'>
                            ...
                            <div>
                                <form onSubmit={login} className='text-slate-600'>
                                    ...
                                    <button className='px-8 w-full py-2 bg-teal-500 shadow-lg hover:shadow-indigo-500/30 text-white rounded-md'>Login</button>
                                </form>
